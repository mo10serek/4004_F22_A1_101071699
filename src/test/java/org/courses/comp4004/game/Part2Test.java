...
public class Part2Test {
    ...
    void row100() {
        ...
        log.println(line);
        log.println(postStatus.outMsg);
        line = "set.dice monkey, monkey, monkey, monkey, sword, parrot, parrot, coin";
        postStatus = messageProcessor.ProcessMessage(line);
        Assertions.assertEquals(postStatus.outMsg,"outcome 2swords, [monkey, monkey, monkey, monkey, sword, parrot, parrot, coin], 300, 0, 0, did not receive correct number of swords");
        log.println(line);
        log.println(postStatus.outMsg);
        line = "set.dice monkey, monkey, monkey, monkey, sword, coin, sword, coin";
        postStatus = messageProcessor.ProcessMessage(line);
        Assertions.assertEquals(postStatus.outMsg,"outcome 2swords, [monkey, monkey, monkey, monkey, sword, coin, sword, coin], 1200, 0, 0, receive correct number of swords");
        log.println(line);
        log.println(postStatus.outMsg);
    }
    ...
    void row116() {
        ...
        log.println(line);
        log.println(postStatus.outMsg);
        line = "set.dice monkey, monkey, skull, skull, skull, sword, sword, sword";
        postStatus = messageProcessor.ProcessMessage(line);
        Assertions.assertEquals(postStatus.outMsg,"outcome 4swords, [monkey, monkey, skull, skull, skull, sword, sword, sword], -1000, 0, 0, did not got the bonus so the player looses points and end his turn");
        log.println(line);
        log.println(postStatus.outMsg);
    }
